<template>
   <div class="flex justify-content-center align-items-center w-full bg-primary p-8">
        <div class="navbar_container">
        <div
          class="navbar"
          v-for="nav_Items in navbar_Items"
          :key="nav_Items.to"
        >
          ...
          <template v-for="items in nav_Items.items" :key="items.to">
            ...
            <template v-if="items?.items2">
              <span class="navbar_panel" @click="menu_items(items.to, items.to)" :class="[active_Index==items.to && 'navbar_panel_active']" :style="{'height' :active_Index.slice(0,3)==items.to? calculate_height(items.items2) : '45px'}" v-show="panel_visibl(items.items2)">
                <div class="navbar_items" :class="[active_Index.slice(0,3)==items.to && 'navbar_items_active',active_Index==items.to && 'navbar_items_active_bg' ]">
                  ...
                  <div class="navbar_items_text">
                    ...
                    <span class="navbar_items_text_icon">
                      <i class="pi pi-angle-right" @click.stop="menu_items('0', '0')"></i>
                    </span>
                  </div>
                </div>
                <div
                  ...
                  :class="[active_Index==sub_items.to && 'navbar_active_bg_color']"
            ...
            <!-- Item -->
            <template v-if="!items?.items2">
              <div  class="navbar_item" @click="menu_items(items.to, items.to)" :class="[active_Index==items.to && 'navbar_item_active']"  v-show='items.visibl' >
                <div class="navbar_item_icon">
                  <i :class="[items.icon]"></i>
                </div>
                <div class="navbar_item_text">
                  <span class="navbar_item_text_content">{{
                    items.label
                  }}</span>
